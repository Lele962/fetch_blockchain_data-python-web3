...
contract MarvinInuETH is ERC20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() ERC20("Marvin Inu ETH", "MarvinInuETH") { // 
        marketingWallet = payable(0x5660aaf05D947f7C04657f937854A143AC855F88); // 
        devWallet = payable(0x5660aaf05D947f7C04657f937854A143AC855F88); // 
