...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x323aBA6790B6D7837fbd7ce2fdBC7C77B49560B5];
  address public erc20Payable = 0x323aBA6790B6D7837fbd7ce2fdBC7C77B49560B5;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 402) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicsm24bqkqv6omfcjn6pa4thoftpsl2bwyj54w6dxkmrhcdggyacu/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/P1gd92Q81k9IUz6OxfiN/contract-metadata";
  }
...
// File: contracts/ForbiddenseriesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ForbiddenseriesContract is ERC721APlus {
    constructor() ERC721APlus("forbidden series", "forbids"){}
}
  /*******************************************************/
  /*                                                     */
