...
contract CHATNZT is ERC20, Ownable {
    ...
    constructor() ERC20("CHAT NZT", "NZT") payable {
        ...
        excludeFromFees(0x879F0d3DA17EF2970c11458F748a403980621B08, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x879F0d3DA17EF2970c11458F748a403980621B08, true);
        ...
        */
        ...
        _createInitialSupply(0x879F0d3DA17EF2970c11458F748a403980621B08, totalSupply*5/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x879F0d3DA17EF2970c11458F748a403980621B08,
            block.timestamp
        );
    }
