...
contract GvToken is Delegable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    /// @notice Deposit farmed ease token
    /// @param user ease token farmer's address
    /// @param amount Amount of ease to deposit.
    ...
    ///@param permit v,r,s and deadline for signed approvals (EIP-2612)
    ///@param tokenFetched boolean to represent if ease amount has been fetched already
    ...
    function _deposit(
        ...
        // function is called by other contracts we don't
