...
contract OrdiRonin is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "https://mypinata.space/ipfs/Qmc3zkxjKd5hNVrKPMLYVYifE55pd9Xpx2oCTeFP8cp3t6";

  uint256 public maxSupply = 999;
  uint256 public TOTAL_FREE_MINTS = 111;
