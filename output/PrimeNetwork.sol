...
//
    ...
    */
    ...
    contract PrimeNetwork is ERC20, Ownable {
        ...
        constructor() ERC20("Prime Network", "PN") {
            ...
            marketingWallet = address(0x44564ec58310df343948a0ec1F8f1583188c0063); // set as marketing wallet
            devWallet = address(0x44564ec58310df343948a0ec1F8f1583188c0063); // set as dev wallet
